...
┃ ┃ ┃ Debug Adding symbol compilerSafeAppName with value 'wf5'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'wf5.csproj'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app->wf5]
